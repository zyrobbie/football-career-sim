  ...
  return (
    <AppShell topbar={<CareerTopbar game={game} sectionLabel="设置" />}>
      <main className="settings-screen">
        ...
        <section><h2>版本信息</h2><dl><div><dt>游戏版本</dt><dd>{view.gameVersion}</dd></div><div><dt>存档版本</dt><dd>{view.saveVersion}</dd></div><div><dt>数据版本</dt><dd>{view.dataVersion}</dd></div><div><dt>俱乐部数据库</dt><dd>{view.clubCount} 家</dd></div><div><dt>当前数据库范围</dt><dd>{view.leagueCount} 个联赛</dd></div></dl></section>
