...
当前阶段：可玩的青训两年与首份职业合同闭环已完成，覆盖：

> 建档 → 生成球员 → 三份青训邀请 → 入队事件 → 四个半年选择与报告 → 一线队关注与晋升评估 → 首份职业合同与一次反报价 → 签约 → 自动存档 → 读档恢复
...
Demo 到15岁签署首份职业合同为止。第二年可以进入观察名单、成为跟训候选、获得跟训机会或正式晋升；合同会根据实际晋升结果承诺青年队或一线队角色。一线队正式比赛尚未开放。
