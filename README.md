...
当前阶段：可玩的青训两年、首份职业合同与第一个职业半年闭环已完成，覆盖：

> 建档 → 生成球员 → 三份青训邀请 → 入队事件 → 四个青训半年 → 一线队关注与晋升评估 → 首份职业合同与一次反报价 → 签约 → 职业半年策略 → 青年队或一线队比赛 → 工资与合同承诺结算 → 自动存档 → 读档恢复
...
Demo 到15岁完成首个职业半年为止。第二年可以进入观察名单、成为跟训候选、获得跟训机会或正式晋升；合同会根据实际晋升结果承诺青年队或一线队角色。签约后按实际球队层级模拟训练与比赛，并结算工资可支配收入、合同期限和角色承诺。正式转会市场尚未开放。
