...
当前阶段：可玩的青训两年、首份职业合同、连续职业半年与表现触发的国内转会闭环已完成，覆盖：

> 建档 → 生成球员 → 三份青训邀请 → 入队事件 → 四个青训半年 → 一线队关注与晋升评估 → 首份职业合同与一次反报价 → 连续职业半年 → 工资与合同承诺结算 → 每隔2至3个窗口评估表现 → 出现转会机会或继续留队 → 合同到期续约或自由转会 → 单次反报价 → 新俱乐部融入事件 → 自动存档 → 读档恢复
...
当前测试版支持职业生涯持续推进。第二年可以进入观察名单、成为跟训候选、获得跟训机会或正式晋升；合同会根据实际晋升结果承诺青年队或一线队角色。签约后按实际球队层级模拟训练与比赛，并结算工资可支配收入、合同期限和角色承诺。转会机会每隔2至3个职业窗口结合最近出场与评分评估，未满18岁的当前版本只开放国内流动；报价与谈判结果会写入存档，刷新不会重抽。
